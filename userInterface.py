...
class MatchPosition():
    def find_snake_or_ladder(self, block, turn, position):
        ...
        if(block == 3):
            ...
            print("HTML is used to...?")
            answer_2 = input("a.Plot complicated graphs\nb. Author webpages\nc. Translate one language into another\nd. Solve equations:")
            if answer_2.lower() == "b":
                print("Correct")
                x = x + 1
            ...
            print("Which is not an internet protocol?")
            answer_3 = input("\n\na.STP\nb. FTP\nc. HTTP\nd. IP:")
            if answer_3.lower() == "a":
                print("Correct")
                x = x + 1
            ...
            print("The abbreviation URL stands for:?\n")
            answer_4 = input("a.User Regulation Law\nb. Unknown RAM Load\nc. Uniform Resource Locator\nd.Ultimate RAM Locator:")
            if answer_4.lower() == "c":
                print("Correct")
                x = x + 1
